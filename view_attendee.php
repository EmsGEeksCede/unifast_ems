...
<?php
if(isset($_GET['id'])){
	$qry = $conn->query("SELECT a.*,concat(a.lastname,', ',a.firstname,' ',a.middlename) as name,e.event FROM attendees a inner join tbl_events e on e.id = a.event_id where a.id = ".$_GET['id'])->fetch_array();
foreach($qry as $k => $v){
	$$k = $v;
}
}
	...
	<div class="card card-widget widget-user shadow">
      ...
      <div class="card-footer">
        <div class="container-fluid">
            ...
            <dt>HEI Name</dt>
            <dd><?php echo ucwords ($hei_name) ?></dd>
            <dt>Region</dt>
            <dd><?php echo $hei_region ?></dd>
        	</dl>
        </div>
    </div>
	</div>
