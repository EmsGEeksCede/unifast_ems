...
<div class=" col-lg-7">
  ...
  <div class="register-logo">
    <a href="#"><b>UniFAST Event Management</b></a>
  </div>
<?php session_start() ?>
<?php include('../admin/db_connect.php'); ?>
<?php 
if(isset($_SESSION['login_id'])){
	$qry = $conn->query("SELECT * from tbl_user_accounts where id = {$_SESSION['login_id']} ");
      ...
      <form id="manage-signup">
	      ...
	      <div class="col-md-12">
	      	<div class="row">
	      		...
	      		<div class="col-md-6">
	      			<div class="input-group mb-3">
			          <input type="email" class="form-control" name="email" required="" placeholder="Email" value="<?php echo isset($email) ? $email : '' ?>" readonly>
			          <div class="input-group-append">
			            <div class="input-group-text">
