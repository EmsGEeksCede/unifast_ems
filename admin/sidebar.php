    ...
    <div class="sidebar">
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column nav-flat" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="./index.php?page=event_list" class="nav-link nav-event_list">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="./index.php?page=attendees_list" class="nav-link nav-attendees_list tree-item">
                  <i class="fas fa-users nav-icon"></i>
                  <p>Attendees Account</p>
                </a>
              </li>
            </ul>
          </li>
